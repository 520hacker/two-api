...
const pptPrompts = [
    "请为初级现代舞蹈课程编写一个教学用的ppt， 包含现代舞蹈的背景,故事,商业,场景,团队,技巧,QA等内容",
    "请为初级花艺课程编写一个介绍用的ppt， 包含花艺的背景,材料,设计,技巧,QA等内容",
    "请为初级茶艺课程编写一个教学用的ppt， 包含茶艺的背景,材料,文化,技巧,QA等内容",
    "请为初级VUEJS课程编写一个介绍用的ppt， 包含背景,特点,基础知识,技巧,QA等内容"
]
const transPrompts = [
